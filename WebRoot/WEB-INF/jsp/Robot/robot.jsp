...
<!-- 	<script type="text/javascript" src="resources/js/insframework/insframeworktree.js"></script> -->
	<script type="text/javascript" src="resources/js/robot/RobotWelding.js"></script>
	<script type="text/javascript" src="resources/js/search/search.js"></script>
	<script type="text/javascript" src="resources/js/robot/addeditRobot.js"></script>
	<script type="text/javascript" src="resources/js/robot/removeRobot.js"></script>
  </head>
...
<%--   	<jsp:include  page="../insframeworktree.jsp"/> --%>
  	<div id="body" >
	    ...
	    <!-- 添加修改 -->
		<div id="dlg" class="easyui-dialog" style="width: 750px; height: 530px; padding:10px 20px" closed="true" buttons="#dlg-buttons">
			<form id="fm" class="easyui-form" method="post" data-options="novalidate:true">
				<div class="fitem">
					<lable><span class="required">*</span>机器人编号</lable>
					<input type="hidden" id="valideno">
					<input class="easyui-textbox" name="equipmentNo" id="equipmentNo"  data-options="validType:['checkNumber','checkLength'],required:true"/>
				...
				<div class="fitem" >
				  ...
				  <div align="center">
		        	<table id="tt" name="tt" title="焊机列表" checkbox="true" style="table-layout:fixed"></table>
		        </div>
			</form>
		</div>
		<div id="dlg-buttons">
