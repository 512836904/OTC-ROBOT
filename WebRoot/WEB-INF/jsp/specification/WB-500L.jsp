...
<html>
  <head>
	...
	<style type="text/css">
	            	...
	            	<table aligin="center">
	            		<tr>
			  				...
			  				<td style="text-align: center;width: 350px;">
			  					<a href="javascript:WBLGET();" class="easyui-linkbutton" iconCls="icon-ok">索取规范</a>
			  					<a href="javascript:WBLSAVE(0);" class="easyui-linkbutton" iconCls="icon-ok">保存</a>
			  					<a href="javascript:wblSendCheck();" class="easyui-linkbutton" iconCls="icon-ok">下发规范</a>
			  					<a href="javascript:WBLINIT(0);" class="easyui-linkbutton" iconCls="icon-ok">恢复默认值</a>
			  					<a href="javascript:openWblCopyDialog(1);" class="easyui-linkbutton" iconCls="icon-ok">焊机参数复制</a>
			  					<a href="javascript:openWblCopyDialog(0);" class="easyui-linkbutton" iconCls="icon-ok">单通道复制</a></td>
			  				<td class="rightTd"></td>
			  			</tr>
	            	</table>
				</div>
					...
					<table width="50%" height="30%" border="1" style="text-align: center;">
					  ...
					  <tr height="30px">
					    <td colspan="2" align="center">					
							...
							<a href="javascript:openWblCopyDialog(3);" class="easyui-linkbutton" iconCls="icon-ok">群发控制命令</a>
        ...
        <div id="dlg-ro">
			<a href="javascript:saveWblCopy();" class="easyui-linkbutton" iconCls="icon-ok">下一步</a>
