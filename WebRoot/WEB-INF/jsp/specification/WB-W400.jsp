...
<html>
  <head>
	...
	<style type="text/css">
  		...
  		<div id="body">
  			...
  			<form id="fm" class="easyui-form" method="post" data-options="novalidate:true">
	            ...
	            <div >
	            	<table>
	            		<tr>
			  				<td class="leftTd"><lable><span class="required">*</span>焊丝负极比率：</lable></td>
			  				<td class="rightTd"><input name="weldingratio" id="weldingratio" class="easyui-numberbox" data-options="required:true">(%)</td>
			  				<td class="leftTd"></td>
			  				<td class="rightTd"></td>
			  			</tr>
	            	</table>
	            	...
	            	<table aligin="center">
	            		<tr>
			  				...
			  				<td style="text-align: center;width: 350px;">
			  					<a href="javascript:WBWGET();" class="easyui-linkbutton" iconCls="icon-ok">索取规范</a>
			  					<a href="javascript:WBWSAVE(0);" class="easyui-linkbutton" iconCls="icon-ok">保存</a>
			  					<a href="javascript:wbwSendCheck();" class="easyui-linkbutton" iconCls="icon-ok">下发规范</a>
			  					<a href="javascript:WBWINIT(0);" class="easyui-linkbutton" iconCls="icon-ok">恢复默认值</a>
			  					<a href="javascript:openWbwCopyDialog(1);" class="easyui-linkbutton" iconCls="icon-ok">焊机参数复制</a>
			  					<a href="javascript:openWbwCopyDialog(0);" class="easyui-linkbutton" iconCls="icon-ok">单通道复制</a></td>
			  				<td class="rightTd"></td>
			  			</tr>
	            	</table>
				</div>
        ...
        <div id="dlg-ro">
			<a href="javascript:saveWbwCopy();" class="easyui-linkbutton" iconCls="icon-ok">下一步</a>
